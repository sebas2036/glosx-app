    ...
    const TRANSLATIONS = {
      en: {
        ...
        modal_trip_title: 'My trip plan', modal_trip_sub: 'Full route generated by WoW Train', modal_trip_note: 'Links open in a new tab — come back whenever you want.', modal_copy_btn: 'Copy itinerary',
        ...
        ai_klook_cta_title: 'Book your {route} train on Klook', ai_klook_cta_sub: 'Compare times & prices · Instant confirmation · Free cancellation on select fares',
        ai_plan_btn: 'Build my complete trip', ai_plan_title: 'My travel plan', ai_plan_sub: 'Full route generated by WoW Train',
        ai_plan_trains: 'Trains', ai_plan_hotels: 'Featured stay per stop', ai_hotel_budget_alt: 'Budget options also available →', ai_plan_copy: 'Copy itinerary', ai_plan_copied: 'Copied', ai_plan_note: 'Links open in a new tab — come back here anytime.',
        ai_hotel_link: 'Find hotels →', ai_hotel_price: 'See current price →', ai_kiwi_cta: 'Transfer on arrival to', ai_stop_label: 'STOP', ai_budget_label: 'Estimated Trip Budget', ai_budget_trains: 'Trains (this route)', ai_budget_daily: 'Hostel + food, per day', ai_budget_disclaimer: 'Estimates only, based on public budget-travel averages — actual prices vary by provider, season and booking date. Always confirm final pricing before purchasing.', ai_high_demand: "We're experiencing high demand right now — please try again in a bit, or pick one of the popular routes above.",
      ...
      es: {
        ...
        modal_trip_title: 'Mi plan de viaje', modal_trip_sub: 'Ruta completa generada por WoW Train', modal_trip_note: 'Los links se abren en pestaña nueva — volvé cuando quieras.', modal_copy_btn: 'Copiar itinerario',
        ...
        ai_klook_cta_title: 'Reserva tu tren {route} en Klook', ai_klook_cta_sub: 'Compara horarios y precios · Confirmación inmediata · Cancelación gratuita en tarifas seleccionadas',
        ai_plan_btn: 'Armar mi viaje completo', ai_plan_title: 'Mi plan de viaje', ai_plan_sub: 'Ruta completa generada por WoW Train',
        ai_plan_trains: 'Trenes', ai_plan_hotels: 'Hotel destacado por parada', ai_hotel_budget_alt: 'También hay opciones de presupuesto →', ai_plan_copy: 'Copiar itinerario', ai_plan_copied: 'Copiado', ai_plan_note: 'Los links se abren en una pestaña nueva — volvé cuando quieras.',
        ai_hotel_link: 'Ver hoteles →', ai_hotel_price: 'Ver precio actual →', ai_kiwi_cta: 'Transfer al llegar a', ai_stop_label: 'PARADA', ai_budget_label: 'Presupuesto estimado del viaje', ai_budget_trains: 'Trenes (esta ruta)', ai_budget_daily: 'Hostel + comida, por día', ai_budget_disclaimer: 'Solo estimaciones, basadas en promedios públicos de viaje con presupuesto — los precios reales varían según el proveedor, la temporada y la fecha de reserva. Confirmá siempre el precio final antes de comprar.', ai_high_demand: 'Estamos con mucha demanda ahora mismo — probá de nuevo en un rato, o elegí una de las rutas populares de arriba.',
      ...
      fr: {
        ...
        modal_trip_title: 'Mon plan de voyage', modal_trip_sub: 'Itinéraire complet généré par WoW Train', modal_trip_note: 'Les liens s\'ouvrent dans un nouvel onglet.', modal_copy_btn: 'Copier l\'itinéraire',
        ...
        ai_klook_cta_title: 'Réservez votre train {route} sur Klook', ai_klook_cta_sub: 'Comparez horaires & prix · Confirmation immédiate · Annulation gratuite sur certains tarifs',
        ...
        ai_plan_trains: 'Trains', ai_plan_hotels: 'Hébergement recommandé par étape', ai_hotel_budget_alt: 'Options économiques également disponibles →', ai_plan_copy: 'Copier l\'itinéraire', ai_plan_copied: 'Copié', ai_plan_note: 'Les liens s\'ouvrent dans un nouvel onglet — revenez quand vous voulez.',
        ai_hotel_link: 'Voir les hôtels →', ai_hotel_price: 'Voir le prix actuel →', ai_kiwi_cta: 'Transfer à l\'arrivée à', ai_stop_label: 'ARRÊT', ai_budget_label: 'Budget de voyage estimé', ai_budget_trains: 'Trains (cet itinéraire)', ai_budget_daily: 'Auberge + repas, par jour', ai_budget_disclaimer: 'Estimations uniquement, basées sur des moyennes publiques de voyage à petit budget — les prix réels varient selon le fournisseur, la saison et la date de réservation. Confirmez toujours le prix final avant d\'acheter.', ai_high_demand: 'Nous connaissons une forte demande en ce moment — réessayez un peu plus tard, ou choisissez l\'un des itinéraires populaires ci-dessus.',
      ...
      de: {
        ...
        modal_trip_title: 'Mein Reiseplan', modal_trip_sub: 'Vollständige Route erstellt von WoW Train', modal_trip_note: 'Links öffnen in einem neuen Tab.', modal_copy_btn: 'Reiseplan kopieren',
        ...
        ai_klook_cta_title: 'Zugticket {route} auf Klook buchen', ai_klook_cta_sub: 'Zeiten & Preise vergleichen · Sofortbestätigung · Kostenlose Stornierung bei ausgewählten Tarifen',
        ai_plan_btn: 'Meine komplette Reise planen', ai_plan_title: 'Mein Reiseplan', ai_plan_sub: 'Vollständige Route von WoW Train',
        ai_plan_trains: 'Züge', ai_plan_hotels: 'Empfohlene Unterkunft pro Halt', ai_hotel_budget_alt: 'Günstigere Optionen ebenfalls verfügbar →', ai_plan_copy: 'Reiseplan kopieren', ai_plan_copied: 'Kopiert', ai_plan_note: 'Links öffnen sich in einem neuen Tab — komm jederzeit zurück.',
        ai_hotel_link: 'Hotels anzeigen →', ai_hotel_price: 'Aktuellen Preis ansehen →', ai_kiwi_cta: 'Transfer bei Ankunft in', ai_stop_label: 'HALT', ai_budget_label: 'Geschätztes Reisebudget', ai_budget_trains: 'Züge (diese Route)', ai_budget_daily: 'Hostel + Essen, pro Tag', ai_budget_disclaimer: 'Nur Schätzungen basierend auf öffentlichen Budget-Reise-Durchschnittswerten — die tatsächlichen Preise variieren je nach Anbieter, Saison und Buchungsdatum. Bestätigen Sie immer den Endpreis vor dem Kauf.', ai_high_demand: 'Wir haben gerade sehr hohe Nachfrage — versuchen Sie es später noch einmal oder wählen Sie eine der beliebten Routen oben.',
      ...
      it: {
        ...
        modal_trip_title: 'Il mio piano di viaggio', modal_trip_sub: 'Itinerario completo generato da WoW Train', modal_trip_note: 'I link si aprono in una nuova scheda.', modal_copy_btn: 'Copia itinerario',
        ...
        ai_klook_cta_title: 'Prenota il tuo treno {route} su Klook', ai_klook_cta_sub: 'Confronta orari e prezzi · Conferma immediata · Cancellazione gratuita su tariffe selezionate',
        ...
        ai_plan_trains: 'Treni', ai_plan_hotels: 'Hotel in evidenza per tappa', ai_hotel_budget_alt: 'Disponibili anche opzioni economiche →', ai_plan_copy: 'Copia itinerario', ai_plan_copied: 'Copiato', ai_plan_note: 'I link si aprono in una nuova scheda — torna quando vuoi.',
        ai_hotel_link: 'Vedi hotel →', ai_hotel_price: 'Vedi prezzo attuale →', ai_kiwi_cta: 'Transfer all\'arrivo a', ai_stop_label: 'TAPPA', ai_budget_label: 'Budget di viaggio stimato', ai_budget_trains: 'Treni (questo percorso)', ai_budget_daily: 'Ostello + cibo, al giorno', ai_budget_disclaimer: 'Solo stime, basate su medie pubbliche di viaggio economico — i prezzi reali variano in base al fornitore, alla stagione e alla data di prenotazione. Conferma sempre il prezzo finale prima di acquistare.', ai_high_demand: 'Stiamo riscontrando molta richiesta in questo momento — riprova tra poco, oppure scegli una delle rotte popolari qui sopra.',
      ...
      pt: {
        ...
        modal_trip_title: 'O meu plano de viagem', modal_trip_sub: 'Rota completa gerada pelo WoW Train', modal_trip_note: 'Os links abrem numa nova aba.', modal_copy_btn: 'Copiar itinerário',
        ...
        ai_klook_cta_title: 'Reserve seu trem {route} no Klook', ai_klook_cta_sub: 'Compare horários e preços · Confirmação imediata · Cancelamento gratuito em tarifas selecionadas',
        ...
        ai_plan_trains: 'Trens', ai_plan_hotels: 'Hotel em destaque por parada', ai_hotel_budget_alt: 'Também há opções econômicas →', ai_plan_copy: 'Copiar itinerário', ai_plan_copied: 'Copiado', ai_plan_note: 'Os links abrem em uma nova aba — volte quando quiser.',
        ai_hotel_link: 'Ver hotéis →', ai_hotel_price: 'Ver preço atual →', ai_kiwi_cta: 'Transfer ao chegar em', ai_stop_label: 'PARAGEM', ai_budget_label: 'Orçamento estimado da viagem', ai_budget_trains: 'Trens (esta rota)', ai_budget_daily: 'Hostel + comida, por dia', ai_budget_disclaimer: 'Apenas estimativas, baseadas em médias públicas de viagens econômicas — os preços reais variam de acordo com o fornecedor, a temporada e a data de reserva. Confirme sempre o preço final antes de comprar.', ai_high_demand: 'Estamos com muita demanda agora — tente novamente em instantes, ou escolha uma das rotas populares acima.',
...
(function () {
  ...
  function displayAIRoute(data) {
    ...
    if (klookCta && origen && destino) {
      ...
      const lang = document.documentElement.lang || 'en';
      const ctaDict = TRANSLATIONS[lang] || TRANSLATIONS.en;
      const ctaTitle = klookCta.querySelector('.ai-klook-cta-title');
      if (ctaTitle) ctaTitle.textContent = (ctaDict.ai_klook_cta_title || 'Book your {route} train on Klook').replace('{route}', `${origen} → ${destino}`);
      const ctaSub = klookCta.querySelector('.ai-klook-cta-sub');
      if (ctaSub) ctaSub.textContent = ctaDict.ai_klook_cta_sub || 'Compare times & prices · Instant confirmation · Free cancellation on select fares';
    }
