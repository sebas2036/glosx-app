    ...
    (function() {
      window.GLOSX_ROUTE_PAGES = new Set(["amsterdam-berlin","amsterdam-brussels","barcelona-valencia","berlin-hamburg","berlin-prague","brussels-bruges","brussels-paris","copenhagen-stockholm","florence-pisa","florence-venice","frankfurt-cologne","frankfurt-munich","geneva-zermatt","interlaken-lauterbrunnen","lisbon-porto","london-edinburgh","london-manchester","london-paris","lyon-turin","madrid-barcelona","madrid-malaga","madrid-seville","madrid-valencia","milan-rome","milan-zurich","montreux-interlaken","munich-berlin","munich-venice","munich-vienna","nice-monaco","oslo-bergen","paris-amsterdam","paris-barcelona","paris-bordeaux","paris-london","paris-nice","paris-toulouse","prague-budapest","prague-vienna","rome-florence","rome-naples","rome-venice","stockholm-oslo","vienna-budapest","vienna-prague","vienna-salzburg","zurich-lucerne","zurich-milan"]);
  ...
  window.openTripPlan = function openTripPlan() {
    ...
    data.tramos.forEach(s => {
      ...
      const stations = (s.estacion_salida && s.estacion_llegada)
        ...
        : `${s.origen} → ${s.destino}`;
      const noTrain = /ferry|autob[uú]s|bus|no aplica|no hay estaci[oó]n|circumvesuviana|jungfraujoch|jungfrau/i.test(
