    ...
    const TRANSLATIONS = {
      ...
      pt: {
        ...
        ai_plan_hotels: 'Hotel em destaque por parada', ai_hotel_budget_alt: 'Também há opções econômicas →', ai_plan_copy: 'Copiar itinerário', ai_plan_copied: 'Copiado', ai_hotel_link: 'Ver hotéis →', ai_hotel_price: 'Ver preço atual →', ai_kiwi_cta: 'Transfer ao chegar em', ai_stop_label: 'PARAGEM', ai_budget_label: 'Orçamento estimado da viagem', ai_budget_trains: 'Trens (esta rota)', ai_budget_daily: 'Hostel + comida, por dia', ai_budget_disclaimer: 'Apenas estimativas, baseadas em médias públicas de viagens econômicas — os preços reais variam de acordo com o fornecedor, a temporada e a data de reserva. Confirme sempre o preço final antes de comprar.', ai_high_demand: 'Estamos com muita demanda agora — tente novamente em instantes, ou escolha uma das rotas populares acima.',
