    ...
    const TRANSLATIONS = {
      ...
      es: {
        ...
        disc_label: 'Comunidad', disc_title1: 'Descubramos', disc_title2: 'juntos.', disc_lead: 'Pueblos y rincones de Europa que solo encuentras en tren — compartidos por viajeros, para viajeros.', disc_cta_title: 'Hoy nos vamos a…', disc_cta_text: 'Girá la ruleta: un par real y el itinerario se arma solo.', disc_cta_btn: 'Tirar la ruleta',
