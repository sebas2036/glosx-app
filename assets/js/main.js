    ...
    const TRANSLATIONS = {
      en: {
        ...
        disc_label: 'Community', disc_title1: "Let's discover", disc_title2: 'together.', disc_lead: "Towns and corners of Europe you'd only ever find by train — shared by travelers, for travelers.", disc_cta_title: 'Know a stop only the train finds?', disc_cta_text: 'Send us the city pair. We publish it on glosx.app.', disc_cta_btn: 'Suggest a stop →', disc_cta_mail: 'mailto:contact@glosx.app?subject=Stop%20for%20glosx.app&body=From%3A%20%0ATo%3A%20%0A',
        ...
        faq5_q: 'Is my data private?', faq5_a: 'No account is required. We use essential cookies and anonymous Google Analytics to understand traffic — see our Privacy Policy and Cookie Policy. We do not sell personal data.',
        ...
        disc_cta_title: 'Know a stop only the train finds?',
        reviews_label: 'Wagon Stories', reviews_title1: 'Voices from', reviews_title2: 'the journey.',
        reviews_lead: 'What they really remember isn\'t the destination — it\'s the moment the train changed everything.', reviews_disclaimer: 'The cards below are illustrative examples. Share your real WoW moment below — it goes live after a quick review.',
        ...
        rv_ph_name: 'Name, Country', rv_ph_route: 'Your train route', rv_ph_body: 'Your WoW train moment...', rv_publish: 'Publish', rv_ok: 'Thanks! Pending review.', rv_error_empty: 'Fill in your name and comment.', rv_chars_label: 'characters remaining',
      ...
      es: {
        ...
        disc_label: 'Comunidad', disc_title1: 'Descubramos', disc_title2: 'juntos.', disc_lead: 'Pueblos y rincones de Europa que solo encuentras en tren — compartidos por viajeros, para viajeros.', disc_cta_title: '¿Un pueblo que solo ves en tren?', disc_cta_text: 'Mandanos el par de ciudades. Lo publicamos en glosx.app.', disc_cta_btn: 'Proponé una parada →', disc_cta_mail: 'mailto:contact@glosx.app?subject=Parada%20para%20glosx.app&body=Desde%3A%20%0AHasta%3A%20%0A',
        ...
        faq5_q: '¿Son privados mis datos?', faq5_a: 'No hace falta cuenta. Usamos cookies esenciales y Google Analytics anónimo para entender el tráfico — ver la Política de privacidad y la Política de cookies. No vendemos datos personales.',
        ...
        disc_cta_title: '¿Un pueblo que solo ves en tren?',
        reviews_label: 'Historias del Vagón', reviews_title1: 'Voces del', reviews_title2: 'trayecto.',
        reviews_lead: 'Lo que recuerdan no es el destino — es el momento en que el tren lo cambió todo.', reviews_disclaimer: 'Las tarjetas de abajo son ejemplos ilustrativos. Compartí tu momento WoW real abajo — se publica luego de una revisión rápida.',
        ...
        rv_ph_name: 'Nombre, País', rv_ph_route: 'Tu ruta de tren', rv_ph_body: 'Tu momento WoW en el tren...', rv_publish: 'Publicar', rv_ok: '¡Gracias! Pendiente de revisión.', rv_error_empty: 'Completa tu nombre y comentario.', rv_chars_label: 'caracteres restantes',
      ...
      fr: {
        ...
        disc_label: 'Communauté', disc_title1: 'Découvrons', disc_title2: 'ensemble.', disc_lead: "Des villages et des recoins d'Europe que l'on ne trouve qu'en train — partagés par les voyageurs, pour les voyageurs.", disc_cta_title: 'Un village que seul le train montre ?', disc_cta_text: 'Envoyez-nous le trajet ville à ville. On le publie sur glosx.app.', disc_cta_btn: 'Proposer une halte →', disc_cta_mail: 'mailto:contact@glosx.app?subject=Arret%20pour%20glosx.app&body=De%3A%20%0AVers%3A%20%0A',
        ...
        faq5_q: 'Mes données sont-elles privées?', faq5_a: 'Aucun compte n\'est requis. Nous utilisons des cookies essentiels et Google Analytics anonyme pour comprendre le trafic — voir la Politique de confidentialité et la Politique de cookies. Nous ne vendons pas de données personnelles.',
        ...
        disc_cta_title: 'Un village que seul le train montre ?',
        reviews_label: 'Histoires du Wagon', reviews_title1: 'Voix du', reviews_title2: 'voyage.',
        reviews_lead: 'Ce qu\'ils retiennent vraiment n\'est pas la destination — c\'est le moment où le train a tout changé.', reviews_disclaimer: 'Les cartes ci-dessous sont des exemples illustratifs. Partagez votre vrai moment WoW ci-dessous — publié après une brève vérification.',
        ...
        rv_ph_name: 'Prénom, Pays', rv_ph_route: 'Votre itinéraire en train', rv_ph_body: 'Votre moment WoW en train...', rv_publish: 'Publier', rv_ok: 'Merci ! En attente de validation.', rv_error_empty: 'Indiquez votre prénom et votre commentaire.', rv_chars_label: 'caractères restants',
      ...
      de: {
        ...
        disc_label: 'Community', disc_title1: 'Entdecken wir', disc_title2: 'gemeinsam.', disc_lead: 'Orte und Winkel Europas, die man nur mit dem Zug findet — geteilt von Reisenden, für Reisende.', disc_cta_title: 'Ein Ort, den nur der Zug zeigt?', disc_cta_text: 'Schick uns das Städtepaar. Wir stellen es auf glosx.app.', disc_cta_btn: 'Halt vorschlagen →', disc_cta_mail: 'mailto:contact@glosx.app?subject=Halt%20fuer%20glosx.app&body=Von%3A%20%0ANach%3A%20%0A',
        ...
        faq5_q: 'Sind meine Daten privat?', faq5_a: 'Kein Konto nötig. Wir nutzen essenzielle Cookies und anonymes Google Analytics, um den Traffic zu verstehen — siehe Datenschutzerklärung und Cookie-Richtlinie. Wir verkaufen keine personenbezogenen Daten.',
        ...
        disc_cta_title: 'Ein Ort, den nur der Zug zeigt?',
        reviews_label: 'Geschichten aus dem Zug', reviews_title1: 'Stimmen von', reviews_title2: 'der Reise.',
        reviews_lead: 'Was sie wirklich in Erinnerung behalten, ist nicht das Ziel — es ist der Moment, als der Zug alles veränderte.', reviews_disclaimer: 'Die Karten unten sind veranschaulichende Beispiele. Teile deinen echten WoW-Moment unten — er wird nach einer kurzen Prüfung veröffentlicht.',
        wt_momento: 'WoW-Moment:',
        ...
        rv_ph_name: 'Name, Land', rv_ph_route: 'Deine Bahnstrecke', rv_ph_body: 'Dein WoW-Moment im Zug...', rv_publish: 'Veröffentlichen', rv_ok: 'Danke! Wird geprüft.', rv_error_empty: 'Bitte Name und Kommentar ausfüllen.', rv_chars_label: 'Zeichen verbleibend',
      ...
      it: {
        ...
        disc_label: 'Community', disc_title1: 'Scopriamo', disc_title2: 'insieme.', disc_lead: "Borghi e angoli d'Europa che trovi solo in treno — condivisi dai viaggiatori, per i viaggiatori.", disc_cta_title: 'Un borgo visibile solo in treno?', disc_cta_text: 'Mandaci la coppia di città. La pubblichiamo su glosx.app.', disc_cta_btn: 'Proponi una fermata →', disc_cta_mail: 'mailto:contact@glosx.app?subject=Fermata%20per%20glosx.app&body=Da%3A%20%0AA%3A%20%0A',
        ...
        faq5_q: 'I miei dati sono privati?', faq5_a: 'Non serve un account. Usiamo cookie essenziali e Google Analytics anonimo per capire il traffico — vedi l\'Informativa sulla privacy e la Cookie Policy. Non vendiamo dati personali.',
        ...
        disc_cta_title: 'Un borgo visibile solo in treno?',
        reviews_label: 'Storie del Vagone', reviews_title1: 'Voci del', reviews_title2: 'viaggio.',
        reviews_lead: 'Quello che ricordano davvero non è la destinazione — è il momento in cui il treno ha cambiato tutto.', reviews_disclaimer: 'Le card qui sotto sono esempi illustrativi. Condividi il tuo vero momento WoW qui sotto — verrà pubblicato dopo una breve revisione.',
        wt_momento: 'Momento WoW:',
        ...
        rv_ph_name: 'Nome, Paese', rv_ph_route: 'Il tuo percorso in treno', rv_ph_body: 'Il tuo momento WoW in treno...', rv_publish: 'Pubblica', rv_ok: 'Grazie! In attesa di revisione.', rv_error_empty: 'Inserisci nome e commento.', rv_chars_label: 'caratteri rimanenti',
      ...
      pt: {
        ...
        disc_label: 'Comunidade', disc_title1: 'Descubramos', disc_title2: 'juntos.', disc_lead: 'Vilas e recantos da Europa que só se encontram de comboio — partilhados por viajantes, para viajantes.', disc_cta_title: 'Uma vila que só o comboio mostra?', disc_cta_text: 'Envia o par de cidades. Publicamos em glosx.app.', disc_cta_btn: 'Propõe uma paragem →', disc_cta_mail: 'mailto:contact@glosx.app?subject=Paragem%20para%20glosx.app&body=De%3A%20%0APara%3A%20%0A',
        ...
        faq5_q: 'Os meus dados são privados?', faq5_a: 'Não é preciso conta. Usamos cookies essenciais e Google Analytics anónimo para perceber o tráfego — ver a Política de privacidade e a Política de cookies. Não vendemos dados pessoais.',
        ...
        disc_cta_title: 'Uma vila que só o comboio mostra?',
        reviews_label: 'Histórias do Vagão', reviews_title1: 'Vozes da', reviews_title2: 'viagem.',
        reviews_lead: 'O que realmente recordam não é o destino — é o momento em que o comboio mudou tudo.', reviews_disclaimer: 'Os cartões abaixo são exemplos ilustrativos. Partilhe o seu momento WoW real abaixo — é publicado após uma breve revisão.',
        wt_momento: 'Momento WoW:',
        ...
        rv_ph_name: 'Nome, País', rv_ph_route: 'O teu percurso de comboio', rv_ph_body: 'O teu momento WoW no comboio...', rv_publish: 'Publicar', rv_ok: 'Obrigado! Pendente de revisão.', rv_error_empty: 'Preenche o nome e o comentário.', rv_chars_label: 'caracteres restantes',
    ...
    function isSeoCrawler() {
      return /googlebot|bingbot|yandex|duckduckbot|slurp|baiduspider|facebookexternalhit|twitterbot|linkedinbot|applebot|gptbot|chatgpt|claudebot|anthropic|bytespider|ccbot/i.test(navigator.userAgent || '');
    }

    function localeFromPath() {
      const m = (location.pathname || '/').match(/^\/(es|fr|it)(?:\/|$)/);
      return m ? m[1] : null;
    }
    ...
    function isHomePath() {
      ...
      return p === '/' || p === '/index.html' || /^\/(es|fr|it)\/?$/.test(p);
    }
    ...
    function applyLang(lang) {
      ...
      const discBtn = document.getElementById('discoverCtaBtn');
      if (discBtn && dict.disc_cta_mail) discBtn.setAttribute('href', dict.disc_cta_mail);
      // Actualizar selector
    ...
    // Home en / se queda en inglés para crawlers y canonical.
    // Visitantes es/fr/it van a /es/ /fr/ /it/ en vez de reescribir el DOM de /.
    (function initLang() {
      ...
      if (onBareHome && !isSeoCrawler()) {
        ...
        if (detected && detected !== 'en' && (detected === 'es' || detected === 'fr' || detected === 'it')) {
          location.replace(homePathForLang(detected) + location.search + location.hash);
          return;
        }
      }
      applyLang(pathLang || (onBareHome ? 'en' : detectLang()));
    })();
    ...
    function runAIPrefillFromUrl() {
      try {
        ...
        var q = p.get('q') || p.get('search_term_string');
        if (!from && !to && !q) return;
        var text = q || ((from && to) ? (from + ' to ' + to) : (from || to));
...
(function () {
  ...
  const DEMO_ROUTES = {
    en: { valido: true, resumen: { origen_fin_o_concepto: 'Madrid → Barcelona', duracion_estimada_total: '2h 30m' }, paradas_principales: ['Madrid', 'Barcelona'], tramos: [
      demoPair(1, 'Madrid', 'Barcelona', 'Madrid Atocha', 'Barcelona Sants', '2h 30m', 'AVE · Renfe', 'AVE')
    ]},
    es: { valido: true, resumen: { origen_fin_o_concepto: 'Madrid → Barcelona', duracion_estimada_total: '2h 30m' }, paradas_principales: ['Madrid', 'Barcelona'], tramos: [
      demoPair(1, 'Madrid', 'Barcelona', 'Madrid Atocha', 'Barcelona Sants', '2h 30m', 'AVE · Renfe', 'AVE')
    ]},
    fr: { valido: true, resumen: { origen_fin_o_concepto: 'Madrid → Barcelone', duracion_estimada_total: '2h 30m' }, paradas_principales: ['Madrid', 'Barcelona'], tramos: [
      demoPair(1, 'Madrid', 'Barcelona', 'Madrid Atocha', 'Barcelona Sants', '2h 30m', 'AVE · Renfe', 'AVE')
    ]},
    de: { valido: true, resumen: { origen_fin_o_concepto: 'Madrid → Barcelona', duracion_estimada_total: '2h 30m' }, paradas_principales: ['Madrid', 'Barcelona'], tramos: [
      demoPair(1, 'Madrid', 'Barcelona', 'Madrid Atocha', 'Barcelona Sants', '2h 30m', 'AVE · Renfe', 'AVE')
    ]},
    it: { valido: true, resumen: { origen_fin_o_concepto: 'Madrid → Barcellona', duracion_estimada_total: '2h 30m' }, paradas_principales: ['Madrid', 'Barcelona'], tramos: [
      demoPair(1, 'Madrid', 'Barcelona', 'Madrid Atocha', 'Barcelona Sants', '2h 30m', 'AVE · Renfe', 'AVE')
    ]},
    pt: { valido: true, resumen: { origen_fin_o_concepto: 'Madrid → Barcelona', duracion_estimada_total: '2h 30m' }, paradas_principales: ['Madrid', 'Barcelona'], tramos: [
      demoPair(1, 'Madrid', 'Barcelona', 'Madrid Atocha', 'Barcelona Sants', '2h 30m', 'AVE · Renfe', 'AVE')
    ]}
  };
  ...
  function showDemoRoute() {
    ...
    const seedQuery = {
      en: 'Madrid to Barcelona',
      es: 'Madrid a Barcelona',
      fr: 'Madrid à Barcelone',
      de: 'Madrid nach Barcelona',
      it: 'Madrid a Barcellona',
