    ...
    (function() {
      window.GLOSX_ROUTE_PAGES = new Set(["amsterdam-berlin","amsterdam-brussels","barcelona-girona","barcelona-valencia","berlin-hamburg","berlin-prague","bordeaux-lourdes","brussels-bruges","brussels-paris","copenhagen-stockholm","florence-pisa","florence-venice","frankfurt-cologne","frankfurt-munich","geneva-zermatt","girona-figueres","interlaken-lauterbrunnen","lisbon-porto","london-edinburgh","london-manchester","london-paris","lyon-turin","madrid-barcelona","madrid-malaga","madrid-seville","madrid-valencia","madrid-zaragoza","milan-rome","milan-zurich","montreux-interlaken","munich-berlin","munich-venice","munich-vienna","naples-salerno","naples-sorrento","nice-monaco","oslo-bergen","paris-amsterdam","paris-barcelona","paris-bordeaux","paris-london","paris-nice","paris-toulouse","prague-budapest","prague-vienna","rome-florence","rome-naples","rome-venice","stockholm-oslo","toulouse-lourdes","vienna-budapest","vienna-prague","vienna-salzburg","zaragoza-barcelona","zurich-lucerne","zurich-milan"]);
    ...
    const KLOOK_HOTEL_CITIES_BY_COUNTRY = {
      ...
      'Sweden': ['Stockholm'],
      'Switzerland': ['Geneva', 'Interlaken', 'Jungfraujoch', 'Lauterbrunnen', 'Lucerne', 'Sargans', 'Zermatt', 'Zurich'],
      'United Kingdom': ['Edinburgh', 'Liverpool', 'London', 'Manchester', 'Oxford', 'York'],
    };
    (function () {
