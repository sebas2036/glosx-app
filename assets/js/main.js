    ...
    const TRANSLATIONS = {
      en: {
        ...
        ai_klook_cta_title: 'See your full {route} plan', ai_klook_cta_sub: 'Train tickets, hotels and booking links in one place',
      ...
      es: {
        ...
        ai_klook_cta_title: 'Mirá tu plan completo {route}', ai_klook_cta_sub: 'Boletos de tren, hoteles y links de reserva en un solo lugar',
      ...
      fr: {
        ...
        ai_klook_cta_title: 'Voir votre plan complet {route}', ai_klook_cta_sub: 'Billets de train, hôtels et liens de réservation au même endroit',
      ...
      de: {
        ...
        ai_klook_cta_title: 'Deinen kompletten Plan {route} ansehen', ai_klook_cta_sub: 'Zugtickets, Hotels und Buchungslinks an einem Ort',
      ...
      it: {
        ...
        ai_klook_cta_title: 'Vedi il tuo piano completo {route}', ai_klook_cta_sub: 'Biglietti del treno, hotel e link di prenotazione in un unico posto',
      ...
      pt: {
        ...
        ai_klook_cta_title: 'Veja seu plano completo {route}', ai_klook_cta_sub: 'Passagens de trem, hotéis e links de reserva em um só lugar',
...
(function () {
  ...
  function displayAIRoute(data) {
    ...
    data.tramos.forEach(async (segment, index) => {
      ...
      const buyHTML = `<a href="${segTicketUrl}" target="_blank" rel="noopener noreferrer" class="ai-segment-buy" onclick="${segTrack}">${segBtnLabel}</a>`;
      setTimeout(() => {
        const segmentHTML = `
